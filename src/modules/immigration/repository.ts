...
function toView(r: CountryRegulation): CountryRegulationView {
  return {
    ...
    visaRequirementsFr: r.visaRequirementsFr,
    requiredDocuments: r.requiredDocuments,
    requiredDocumentsFr: r.requiredDocumentsFr,
    processingTimeDays: r.processingTimeDays,
    entryConditions: r.entryConditions,
    entryConditionsFr: r.entryConditionsFr,
    ...
    healthRequirementsFr: r.healthRequirementsFr,
    travelAdvisories: r.travelAdvisories,
    travelAdvisoriesFr: r.travelAdvisoriesFr,
    specialRestrictions: r.specialRestrictions,
    specialRestrictionsFr: r.specialRestrictionsFr,
