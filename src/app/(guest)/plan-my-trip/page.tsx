...
// package matching/scoring happens anymore. Deliberately without
// StepIndicator, same as the tailor-made page it replaces -- this isn't
// part of the direct-package-browse journey (BOOKING_WIZARD_STEPS); it's
// the other booking origin, with no pre-existing Departure, priced by
// staff afterward via a quotation (see bookingService.createTailorMadeRequest).
