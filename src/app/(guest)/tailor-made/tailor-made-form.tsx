...
import { createTailorMadeRequestAction } from './actions';

// Mirrors (guest)/book/[departureId]/booking-form.tsx -- same anonymous-
// session-then-server-action shape, see that file for the FormData-before-
// await and error-handling reasoning this copies verbatim.
export default function TailorMadeForm() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const result = await createTailorMadeRequestAction(formData);
      if ('error' in result) {
