  ...
  return (
    <Reveal>
      {/* Same full-bleed photo treatment as /find-booking (explicit user
          ...
          Photo (and the full-bleed breakout itself) is sm+ only, same
          explicit user request as /find-booking -- overstretched/zoomed-in
          on a phone viewport otherwise. */}
      <section className="relative flex items-center justify-center overflow-hidden py-16 sm:left-1/2 sm:right-1/2 sm:-mx-[50vw] sm:min-h-[32rem] sm:w-screen sm:px-8">
        <Image src="/images/hero/etosha-zebra-waterhole.jpg" alt="" fill priority sizes="100vw" className="hidden object-cover sm:block" />
