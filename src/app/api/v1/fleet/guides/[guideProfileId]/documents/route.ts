...
export const POST = withAuth<Params>('fleet.write', async (ctx, req: NextRequest, { guideProfileId }) => {
  ...
  const document = await fleetService.uploadGuideDocument(ctx, guideProfileId, {
