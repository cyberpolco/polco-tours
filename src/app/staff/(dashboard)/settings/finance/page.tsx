...
export default async function FinanceHubPage() {
  ...
  const cards = [
    ...
    // DR-240 originally grouped this under its own "Add-ons" heading
    // alongside Flight Fares/eSIM Plans; DR-243 folded those two into this
    // page's own "Add-on Services" card, leaving "Add-ons" a one-card
    // section with nothing left to group it against -- DR-249 (explicit
    // user correction) removes that now-pointless heading entirely and
    // puts this card back with the other plain Finance settings.
